...
using Presentation.Presentation.Controllers;
...
public static class ServiceExtensions
{
    ...
    public static void ConfigureVersioning(this IServiceCollection services)
    {
        services.AddApiVersioning(opt =>
        {
            ...
            //or opt.ApiVersionReader = new QueryStringApiVersionReader("api-version");
    ...
    public static void ConfigureJWT(this IServiceCollection services, IConfiguration configuration)
    {
        ...
        var secretKey = "damnnicekeysheeshultraextracomplexity";//Environment.GetEnvironmentVariable("SECRET");
    ...
    public static void ConfigureSwagger(this IServiceCollection services)
    {
        services.AddSwaggerGen(s =>
        {
            ...
            var xmlFile = $"{typeof(Presentation.Presentation.AssemblyReference).Assembly.GetName().Name}.xml";
